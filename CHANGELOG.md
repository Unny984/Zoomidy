...
- Support for LeviLamina **26.51.x** / Minecraft Bedrock client **1.26.51.1**, alongside the
  26.20.x and 26.10.x lines. Install it with `lip install github.com/Unny984/Zoomidy#client_26_51`;
  the plain package name still installs the 26.20.x build.

  Like 26.20, the 26.51 build is compiled with clang and uses the single-page settings screen.
...
[0.5.0]: https://github.com/Unny984/Zoomidy/releases/tag/v0.5.0
